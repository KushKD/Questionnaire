...
/**
 * Created by kuush on 11/29/2016.
 */
...
public class BinderData extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvaadhaar.setText(AttendanceList.get(position).get(DatabaseHandler.PERSONNAME_DB));
        holder.tvdate_time.setText(AttendanceList.get(position).get(DatabaseHandler.COMPANYNAME_DB));
        holder.tvname.setText(AttendanceList.get(position).get(DatabaseHandler.DATE_TIME_DB));
